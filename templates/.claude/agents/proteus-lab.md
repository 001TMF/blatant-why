...
tools: Read, Bash, Grep, Glob, mcp__proteus-adaptyv__*, mcp__proteus-campaign__*, mcp__proteus-screening__*, mcp__proteus-knowledge__*
disallowedTools: mcp__proteus-cloud__cloud_submit_job
---
...
- Call `mcp__proteus-adaptyv__*` to request a confirmation code
...
- Read campaign state via `mcp__proteus-campaign__*`
...
6. **Submit to Adaptyv** -- Only if all three gates pass:
   - Use `mcp__proteus-adaptyv__*` to submit the batch
