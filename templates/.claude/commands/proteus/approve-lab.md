...
```bash
cat > .proteus/campaigns/$CAMPAIGN_ID/lab/approval.json << EOF
{
  "approved": true,
  "approved_by": "user",
...
### Step 6: Spawn proteus-lab agent

Delegate to a **proteus-lab** agent (model per profile table above):
